...
class YT8MFrameFeatureReader(BaseReader):
  ...
  def __init__(  
    ...
    self.max_frames = FLAGS.max_frames
  ...
  def get_video_matrix(self, features, feature_size, max_frames,
    ...
    print('decoded_features',decoded_features.shape)
  ...
  def prepare_serialized_examples(self,
    ...
    if FLAGS.diff:
      ...
      video_matrix=tf.pad(video_matrix, paddings, "CONSTANT")
      # print('video_matrix',video_matrix)
      video_matrix=(2*video_matrix[1:-1,:]-video_matrix[:-2,:]-video_matrix[2:,:])/2
    print('video_matrix',video_matrix)
